...
import createInstallChartTabInjectable, { CreateInstallChartTab } from "../dock/install-chart/create-install-chart-tab.injectable";
...
export const HelmChartDetails = withInjectables<Dependencies, Props>(NonInjectedHelmChartDetails, {
  getProps: (di, props) => ({
    ...props,
