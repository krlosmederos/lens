...
import extensionsPreferencesStoreInjectable from "../../renderer/extensions/store.injectable";
...
type StoreCreatePair<T> = [Injectable<T, T, void>, Injectable<T, unknown, BaseStoreParams<any>>];
