...
export type QueryForLogs = (params: ResourceDescriptor, query?: IPodLogsQuery) => Promise<string>;
...
export class PodApi extends KubeApi<Pod> implements PodApiQueries {
  ...
  async getLogs(params: ResourceDescriptor, query?: IPodLogsQuery): Promise<string> {
